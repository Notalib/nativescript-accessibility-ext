...
import {
  AccessibilityLiveRegion as _AccessibilityLiveRegion,
  AccessibilityRole as _AccessibilityRole,
  AccessibilityState as _AccessibilityState,
  AccessibilityTrait as _AccessibilityTrait,
} from './view-common';
