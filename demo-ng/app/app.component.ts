...
export class AppComponent {
  public readonly traits = [
    ...
    {
      key: 'button',
      label: ' Used when the element should be treated as a button.',
    },
    {
      key: 'link',
      label: ' Used when the element should be treated as a link.',
    },
    {
      key: 'header',
      label:
    ...
    {
      key: 'plays',
      label: ' Used when the element plays its own sound when activated.',
    },
    ...
    {
      key: 'adjustable',
      label: ' Used when an element can be "adjusted" (e.g. a slider).',
    },
    {
