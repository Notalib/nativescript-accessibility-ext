      ...
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        const Slides = class {
          ...
          async initSwiper() {
            ...
            // init swiper core
            // @ts-ignore
            const { Swiper } = await __webpack_require__
              .e(/*! import() */ 'node_modules_ionic_core_dist_esm_swiper_bundle-6c5e7804_js')
              .then(__webpack_require__.bind(__webpack_require__, /*! ./swiper.bundle-6c5e7804.js */ 8669));
          ...
          render() {
            ...
            return (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(
              ...
              this.pager &&
                (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { class: 'swiper-pagination', ref: (el) => (this.paginationEl = el) }),
              this.scrollbar &&
                (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)('div', { class: 'swiper-scrollbar', ref: (el) => (this.scrollbarEl = el) }),
            );
          }
        ...
        const waitForSlides = (el) => {
          return Promise.all(
            Array.from(el.querySelectorAll('ion-slide')).map(
              (s) => new Promise((resolve) => (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.c)(s, resolve)),
            ),
          );
        };
        Slides.style = {
